...
const Contact = () => {
  ...
  return (
    <div className="text-white bg-[#0A0B10] p-8 h-screen">
          ...
          <form ref={form} onSubmit={sendEmail}>
            ...
            <div className="flex flex-col mt-12">
              ...
              <textarea
                ...
                name="message"
                placeholder="Message"
                className="border-[#A1CDFF1A] border-b-1 pt-5 pb-5 pl-2 mb-4 w-[580px]"
              />
              <button
                type="submit"
                className="bg-[#1E8BF2] mt-4 mb-4 rounded-xl w-[180px] h-[40px] font-semibold"
              >
                Send Message
              </button>
            </div>
