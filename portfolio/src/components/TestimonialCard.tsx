...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ testimonial, onNext }) => {
    return (
        <div className="flex flex-col rounded-xl bg-[#131314] border-[1px] border-[#A1CDFF14] p-4 h-full">
            <div className="flex flex-row pb-4">
                <div className="pr-6">
                    <img src={testimonial.avatar || "/placeholder.svg"} alt={testimonial.name} className="w-14 h-14 rounded-xl" />
                </div>
                <div>
            ...
            <div className="flex-1">
                ...
                <div className="flex justify-end -mt-5">
                    <button onClick={onNext} className="hover:opacity-80 transition-opacity">
